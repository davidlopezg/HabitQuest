...
export const CATALOG: BehaviorTemplate[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 2, minutes: 1, label: 'Ponlo junto a una rutina que ya hagas (café o cepillarte).' },
  ...
  },
  {
    ...
    purpose: 'Plan genérico de 3 pasos incrementales (mínimo viable). Sirve para objetivos nuevos que aún no tienen un preset propio.',
    startRitual: ['Abre la app o el material 1 min, sin más', 'Avanza 5 min concretos', 'Sube a 15 min manteniéndolo simple'],
    levels: [
      { level: 1, minutes: 1, label: 'Solo dedicar 1 min al objetivo, sin presión.', need: 3, window: 5 },
      { level: 2, minutes: 5, label: '5 min concretos, una sola cosa.' },
      { level: 3, minutes: 10, label: '10 min con foco, sin multitarea.' },
      { level: 4, minutes: 15, label: '15 min manteniendo el ritmo.' },
      { level: 5, minutes: 20, label: '20 min, ya consolidado.' },
      { level: 6, minutes: 25, label: '25 min de práctica real.' },
